...
const Register = () => {
	...
	return (
		<>
			...
			<div className="home">
				<Layout>
					<section className="flex flex-col items-center mt-[50px] lg:mt-[0px]">
						<div className="text-center md:pt-[100px]">
							<h1 className="text-2xl font-bold text-neutral-50">Sign Up</h1>
							<p className="w-[55%] mx-auto mt-5 mb-10 text-neutral-50">
								By creating account with us, you consent to receiving
								newsletters or promotions from{' '}
								<Link to="/">
						...
						<article className="w-full">
							<form onSubmit={handleSubmit}>
								...
								<div className="text-center text-xs text-red-800">
									{authUser.error ? (
										<p>Error message: {authUser.error}</p>
									) : null}
								</div>
						...
						<div>
							<p className="font-light mb-10 w-[70%] mx-auto text-center text-neutral-50">
